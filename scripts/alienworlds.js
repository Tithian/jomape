...
let l, ese, n, h, d, g, c, b, p, u;

function w() {
    l = 0 | e(1e9), ese = e(), n = (new o).setHSLA(ese, e(), e(.5)), h = (new o).setHSLA(ese + e(.3, .7), e(), e(.8, .2)), d = e(1e3), g = ((t = new o, i = new o(0, 0, 0, 1), r) => r ? t.lerp(i, e()) : new o(e(t.r, i.r), e(t.g, i.g), e(t.b, i.b), e(t.a, i.a)))(new o(.1, .1, .1), new o(.9, .9, .9)), c = e(12, 1) * (e() < .5 ? 1 : -1), b = e() < .5, p = e() < .5, u = e() < .03 ? 0 : 1 + e() ** 2 * 5 | 0
}
w(), onclick = t => w();
let f = 0,
    m = 0,
    ...
    y = (Math.sin, Math.cos, Math.tan, e => {
        ...
        for (let r = 0; ++r < 8;) {
            ...
            for (let t = 3e3; t--;) {
                ...
                Math.abs(e) < 1 && (s = e * (b ? 3 : 1.5) * l), h += s -= h / 2e3, C.lineTo((t + u - 1) * r, h * r ** .7 / 2 + w)
            }
